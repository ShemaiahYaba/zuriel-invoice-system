...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="bi bi-box-seam"></i> Add New Product/Service</h2>
        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="<?php echo Config::url('products/store'); ?>">
                    <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
                    
                    <div class="mb-3">
                        <label class="form-label">Product/Service Description *</label>
                        <textarea name="description" class="form-control" rows="3" 
                                  placeholder="Enter product or service description" required></textarea>
                    </div>
