...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="bi bi-pencil-square"></i> Edit Invoice</h2>
            <a href="<?php echo Config::url('invoices'); ?>" class="btn btn-secondary">
                <i class="bi bi-arrow-left"></i> Back to Invoices
            </a>
        </div>
        
        <form method="POST" action="<?php echo Config::url('invoices/update/' . $invoice['id']); ?>" id="invoiceForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="invoice_type" class="form-select" required>
                                <option value="cash" <?php echo $invoice['invoice_type'] === 'cash' ? 'selected' : ''; ?>>Cash</option>
                                <option value="credit" <?php echo $invoice['invoice_type'] === 'credit' ? 'selected' : ''; ?>>Credit</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="lpo_number" class="form-control" 
                                   value="<?php echo htmlspecialchars($invoice['lpo_number'] ?? ''); ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="customer_name" id="customerName" 
                                   class="form-control" value="<?php echo htmlspecialchars($invoice['customer_name']); ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Customer Address</label>
                            <textarea name="customer_address" id="customerAddress" 
                                      class="form-control" rows="2"><?php echo htmlspecialchars($invoice['customer_address'] ?? ''); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table" id="itemsTable">
                                ...
                                <tr class="item-row">
                                    <td>
                                        <input type="number" name="qty[]" class="form-control qty-input" 
                                               min="1" value="<?php echo $item['qty']; ?>" onchange="calculateRow(this)">
                                    </td>
                                    <td>
                                        <input type="text" name="description[]" class="form-control" 
                                               list="productsList" value="<?php echo htmlspecialchars($item['description']); ?>" 
                                               placeholder="Start typing...">
                                    </td>
                                    <td>
                                        <input type="number" name="rate[]" class="form-control rate-input" 
                                               step="0.01" min="0" value="<?php echo $item['rate']; ?>" onchange="calculateRow(this)">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control amount-display" readonly value="<?php echo number_format($item['amount'], 2); ?>">
                                    </td>
                                    <td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="totalAmount" class="form-control fw-bold" readonly value="<?php echo number_format($invoice['total'], 2); ?>">
                                    </td>
                                    <td></td>
                                </tr>
                            </tfoot>
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="<?php echo Config::url('invoices'); ?>" class="btn btn-secondary">Cancel</a>
